...
The purpose of this vignette is to show the functionalities of the new R-package **spsur** [@MinguezJSS2022; @Lopez2020]. In the vignette the reader will find information about the following aspects:
...
Figure 2 shows the Quantile map for the Homicide Rate in the year 1960. Apparently there exist a strong structure of positive spatial autocorrelation. We observe a big cluster of the type High-High in the South East and South West counties, which evolves to Low-Low as we move to the North.
...
![Figure 2: Quantile Map; Variable HR60](quantilemap-1.png "Figure 2: Quantile Map; Variable HR60") 
...
Figure 2 points to the existence of cross-sectional dependence in the spatial distribution of HR60 but the model in \@ref(eq:ols) does not contain elements of spatial interaction. The consequence is a scattermap of the LS residuals, Figure 3, with a strong structure of clusters, similar to that of HR60 in Figure 2.
...
![Figure 3: Quantile Map of LS residuals](residualquantilemap-1.png "Figure 3: Quantile Map of LS residuals")
...
Figure 4 shows the quantile maps of the SUR residuals corresponding to the years 1960 and 1970. The maps reveal that time dependence was only part of the problem. Indeed, there remain a strong spatial structure in the SUR residuals which is apparently stable across time.
...
![Figure 4: Quantile Map of LS residuals for SUR-SIM model](residualsurquantilemap-1.png "Figure 4: Quantile Map of LS residuals for SUR-SIM model")
...
#> Time to compute covariances:  0.22  seconds
```
...
#> Time to fit the model:  8.66  seconds
#> Computing numerical covariances... 
#> Time to compute covariances:  2.15  seconds
```
...
#> (Intercept)  5.6077  0.000  5.1575      0
#> RD60         1.3344  0.000      NA     NA
#> PS60         0.2745  0.002      NA     NA
#> MA60        -0.1668  0.000      NA     NA
#> DV60         0.8794  0.000      NA     NA
#> UE60        -0.0304  0.364      NA     NA
#> SOUTH        1.5061  0.000  1.6169      0
#> RD70             NA     NA  2.2014      0
#> PS70             NA     NA  0.6485      0
#> MA70             NA     NA -0.1219      0
#> DV70             NA     NA  0.9875      0
#> UE70             NA     NA -0.1690      0
#> rho          0.3467  0.000  0.3933      0
```
...
#> Time to fit the model:  11.62  seconds
#> Computing numerical covariances... 
#> Time to compute covariances:  2.82  seconds
```
...
#> Time to fit the model:  12.02  seconds
#> Computing numerical covariances... 
#> Time to compute covariances:  2.8  seconds
```
...
#> Time to fit the model:  9.85  seconds
#> Time to compute covariances:  21.21  seconds
```
...
#> Time to fit the model:  247.33  seconds
#> Computing numerical covariances... 
#> Time to compute covariances:  16.03  seconds
```
...
```
#> sparse matrix LU decomposition
#> Initial point:   log_lik:  -18720.21  rhos:  -0.69 0.542  lambdas:  0.685 -0.239 
#> Iteration:  1  log_lik:  -18687.14  rhos:  -0.917 0.645  lambdas:  0.773 -0.426 
#> Iteration:  2  log_lik:  -18683.28  rhos:  -0.992 0.669  lambdas:  0.797 -0.476 
#> Iteration:  3  log_lik:  -18682.89  rhos:  -1 0.675  lambdas:  0.802 -0.49 
#> Iteration:  4  log_lik:  -18682.88  rhos:  -1 0.677  lambdas:  0.802 -0.494 
#> Iteration:  5  log_lik:  -18682.88  rhos:  -1 0.678  lambdas:  0.802 -0.495 
#> Time to fit the model:  194.16  seconds
#> Computing numerical covariances... 
#> Time to compute covariances:  16.59  seconds
```
...
#> Equation  1 
#>                Estimate Std. Error  t value  Pr(>|t|)    
#> (Intercept)_1 17.637671   0.762287  23.1378 < 2.2e-16 ***
#> RD60_1         1.558080   0.178061   8.7503 < 2.2e-16 ***
#> PS60_1         0.376947   0.124103   3.0374  0.002397 ** 
#> MA60_1        -0.180938   0.026815  -6.7476 1.641e-11 ***
#> DV60_1         0.746906   0.114355   6.5315 7.035e-11 ***
#> UE60_1         0.046907   0.041110   1.1410  0.253915    
#> SOUTH_1        0.523163   0.760957   0.6875  0.491790    
#> lag.RD60_1     2.403661   0.231207  10.3961 < 2.2e-16 ***
#> lag.PS60_1     0.154981   0.168389   0.9204  0.357415    
#> lag.MA60_1    -0.323422   0.035598  -9.0855 < 2.2e-16 ***
#> lag.DV60_1     2.115808   0.166330  12.7206 < 2.2e-16 ***
#> lag.UE60_1    -0.286290   0.063278  -4.5243 6.173e-06 ***
#> lag.SOUTH_1    3.652172   0.813929   4.4871 7.352e-06 ***
#> rho_1         -1.000000   0.064391 -15.5300 < 2.2e-16 ***
#> lambda_1       0.801956   0.020253  39.5978 < 2.2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> R-squared: 0.4652 
#>   Equation  2 
#>                Estimate Std. Error t value  Pr(>|t|)    
#> (Intercept)_2  4.388868   1.013975  4.3284 1.526e-05 ***
#> RD70_2         2.570551   0.207109 12.4116 < 2.2e-16 ***
#> PS70_2         0.651371   0.159736  4.0778 4.604e-05 ***
#> MA70_2        -0.077525   0.028820 -2.6900 0.0071643 ** 
#> DV70_2         1.064836   0.126071  8.4463 < 2.2e-16 ***
#> UE70_2        -0.048163   0.063024 -0.7642 0.4447766    
#> SOUTH_2        0.014559   0.986988  0.0148 0.9882313    
#> lag.RD70_2    -1.722619   0.286084 -6.0214 1.829e-09 ***
#> lag.PS70_2    -0.387912   0.217997 -1.7794 0.0752177 .  
#> lag.MA70_2    -0.033303   0.042225 -0.7887 0.4303147    
#> lag.DV70_2    -0.629841   0.186557 -3.3761 0.0007397 ***
#> lag.UE70_2    -0.096449   0.091567 -1.0533 0.2922402    
#> lag.SOUTH_2    1.233415   1.064744  1.1584 0.2467401    
#> rho_2          0.677561   0.035178 19.2607 < 2.2e-16 ***
#> lambda_2      -0.494567   0.083217 -5.9431 2.951e-09 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> R-squared: 0.4614 
#>   
...
#> 
#>  R-sq. pooled: 0.4725 
#>  Breusch-Pagan: 119.3  p-value: (8.99e-28)
```
...
```
#> Time to fit the model:  0.27  seconds
```
...
```
#> Time to fit the model:  0.35  seconds
```
...
#> Iteration:  2   log_lik:  -18761.48  rhos:  0.347 0.393 
#> Iteration:  3   log_lik:  -18761.48  rhos:  0.347 0.393 
#> Time to fit the model:  8.59  seconds
#> Time to compute covariances:  15.02  seconds
```
...
#> Time to fit the model:  3.28  seconds
#> Time to compute covariances:  13.44  seconds
```
...
#> SOUTH_2        1.546569   0.206496  7.4896 7.882e-14 ***
...
#> Time to fit the model:  3.53  seconds
#> Time to compute covariances:  13.61  seconds
```
...
#>   Equation  2 
#>                Estimate Std. Error t value  Pr(>|t|)    
#> (Intercept)_2  5.423289   0.528372 10.2641 < 2.2e-16 ***
...
#> SOUTH_2        1.550475   0.206478  7.5092 6.797e-14 ***
...
#>   Equation  2 
#>                Estimate Std. Error t value  Pr(>|t|)    
#> (Intercept)_2  4.269568   0.677692  6.3002 3.179e-10 ***
...
#> model 2: slx -18855 29 37768 37731 106.87 2.483e-17
```
...
```
#>                logLik df   AIC   BIC LRtest      p.val
#> model 1: slm   -18762 19 37561 37536                  
#> model 2: sarar -18722 21 37487 37459 78.111 1.0925e-17
```
...
```
#>              logLik df   AIC   BIC  LRtest   p.val
#> model 1: slm -18762 17 37557 37535                
#> model 2: slm -18762 19 37561 37536 0.31287 0.85519
```
...
```r
Wncovr <- Matrix::Matrix(spdep::list2mat(lwncovr))
...
#> RD60_1   1.35213975  0.69042771  2.04256745
#> PS60_1   0.27817647  0.14204208  0.42021855
#> MA60_1  -0.16905446 -0.08632235 -0.25537681
#> DV60_1   0.89108131  0.45500269  1.34608401
#> UE60_1  -0.03084949 -0.01575232 -0.04660181
#> SOUTH_1  1.52605595  0.77923255  2.30528850
#> ========================================================
#> Simulation results ( variance matrix):
#> ========================================================
#> Simulated standard errors
#>             Direct   Indirect      Total
#> RD60_1  0.11703831 0.10448274 0.19901068
#> PS60_1  0.08940017 0.04840224 0.13563805
#> MA60_1  0.01871509 0.01412591 0.03019991
#> DV60_1  0.09273968 0.07466478 0.15383048
#> UE60_1  0.03282561 0.01681956 0.04950094
#> SOUTH_1 0.22889434 0.14842343 0.35699832
#> 
#> Simulated z-values:
#>             Direct   Indirect     Total
#> RD60_1  11.4815668  6.5829830 10.208453
#> PS60_1   3.0716621  2.9009683  3.059764
#> MA60_1  -9.0599755 -6.1415086 -8.487197
#> DV60_1   9.6135076  6.1138683  8.763180
#> UE60_1  -0.9354442 -0.9319543 -0.936984
#> SOUTH_1  6.6935936  5.2795053  6.486664
#> 
#> Simulated p-values:
#>         Direct     Indirect   Total     
#> RD60_1  < 2.22e-16 4.6110e-11 < 2.22e-16
#> PS60_1  0.0021287  0.0037201  0.0022151 
#> MA60_1  < 2.22e-16 8.1741e-10 < 2.22e-16
#> DV60_1  < 2.22e-16 9.7245e-10 < 2.22e-16
#> UE60_1  0.3495594  0.3513601  0.3487668 
#> SOUTH_1 2.1775e-11 1.2953e-07 8.7758e-11
```
...
#> Impact measures (lag, trace):
#>             Direct    Indirect      Total
#> RD70_2   2.2404848  1.38775098  3.6282358
#> PS70_2   0.6600567  0.40883756  1.0688942
#> MA70_2  -0.1240170 -0.07681585 -0.2008329
#> DV70_2   1.0050239  0.62250940  1.6275333
#> UE70_2  -0.1719837 -0.10652629 -0.2785100
#> SOUTH_2  1.6456920  1.01933775  2.6650298
#> ========================================================
#> Simulation results ( variance matrix):
#> ========================================================
#> Simulated standard errors
#>             Direct   Indirect      Total
#> RD70_2  0.14643676 0.17648186 0.28280140
#> PS70_2  0.11364985 0.08239305 0.18802458
#> MA70_2  0.02225844 0.01624519 0.03715816
#> DV70_2  0.09969887 0.09373538 0.17813204
#> UE70_2  0.04851033 0.03250015 0.07962182
#> SOUTH_2 0.26315022 0.19921014 0.44205944
#> 
#> Simulated z-values:
#>            Direct  Indirect     Total
#> RD70_2  15.271393  7.876525 12.822981
#> PS70_2   5.870699  5.028814  5.752138
#> MA70_2  -5.516492 -4.698497 -5.358620
#> DV70_2  10.041132  6.640642  9.114321
#> UE70_2  -3.532639 -3.275616 -3.489338
#> SOUTH_2  6.253998  5.135172  6.037015
#> 
#> Simulated p-values:
#>         Direct     Indirect   Total     
#> RD70_2  < 2.22e-16 3.3307e-15 < 2.22e-16
#> PS70_2  4.3396e-09 4.9352e-07 8.8122e-09
#> MA70_2  3.4583e-08 2.6208e-06 8.3860e-08
#> DV70_2  < 2.22e-16 3.1232e-11 < 2.22e-16
#> UE70_2  0.00041143 0.0010543  0.00048422
#> SOUTH_2 4.0008e-10 2.8189e-07 1.5699e-09
```
...
#> Iteration:  2   log_lik:  -18761.48  rhos:  0.347 0.393 
#> Iteration:  3   log_lik:  -18761.48  rhos:  0.347 0.393 
#> Time to fit the model:  2.81  seconds
#> Time to compute covariances:  13.44  seconds
```
...
#> Computing numerical covariances... 
#> Time to compute covariances:  2.18  seconds
```
...
#> Iteration:  3   log_lik:  -23814.73  rhos:  0.543 0.894 
#> Iteration:  4   log_lik:  -23814.73  rhos:  0.543 0.894 
#> Time to fit the model:  15.62  seconds
#> Computing numerical covariances... 
#> Time to compute covariances:  2.38  seconds
```
...
#> Equation  1 
#>            Estimate Std. Error t value  Pr(>|t|)    
#> Intercep_1 0.959207   0.055699  17.221 < 2.2e-16 ***
#> X1_1       2.026348   0.046773  43.323 < 2.2e-16 ***
#> X1_2       3.067916   0.042537  72.124 < 2.2e-16 ***
#> rho_1      0.506645   0.015327  33.055 < 2.2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> R-squared: 0.9441 
#>   Equation  2 
#>             Estimate Std. Error t value  Pr(>|t|)    
#> Intercep_2  1.121547   0.092200  12.164 < 2.2e-16 ***
#> X2_1       -1.079978   0.045058 -23.968 < 2.2e-16 ***
#> X2_2        0.473361   0.044973  10.526 < 2.2e-16 ***
#> rho_2       0.444652   0.040186  11.065 < 2.2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> R-squared: 0.6164 
#>   Equation  3 
#>             Estimate Std. Error t value  Pr(>|t|)    
#> Intercep_3  0.997241   0.072371  13.780 < 2.2e-16 ***
#> X3_1       -0.501703   0.040879 -12.273 < 2.2e-16 ***
#> X3_2        2.042920   0.042384  48.200 < 2.2e-16 ***
#> rho_3       0.486816   0.025774  18.888 < 2.2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> R-squared: 0.8453 
#>   
#> Variance-Covariance Matrix of inter-equation residuals:                              
#>  1.0668570 0.2677292 0.3455255
#>  0.2677292 1.0861678 0.2622235
#>  0.3455255 0.2622235 1.0375186
#> Correlation Matrix of inter-equation residuals:                              
#>  1.0000000 0.2487106 0.3284196
#>  0.2487106 1.0000000 0.2470160
#>  0.3284196 0.2470160 1.0000000
#> 
#>  R-sq. pooled: 0.8886 
#>  Breusch-Pagan: 115.4  p-value: (7.68e-25) 
#>  LMM: 2.8434  p-value: (0.416)
```
