...
#> 
#> data:  NCOVR.sf
#> LM-stat = 25.181, df = 1, p-value = 5.218e-07
#> 
#> 
#> [[4]]
#> 
...
#> Time to fit the model:  1.54  seconds
#> Time to compute covariances:  4.63  seconds
```
...
#> Equation  1 
#>                Estimate Std. Error t value  Pr(>|t|)    
#> (Intercept)_1  5.473546   0.647627  8.4517 < 2.2e-16 ***
#> RD60_1         1.357784   0.125733 10.7989 < 2.2e-16 ***
#> PS60_1         0.284344   0.089317  3.1835  0.001469 ** 
#> MA60_1        -0.165429   0.019384 -8.5342 < 2.2e-16 ***
#> DV60_1         0.884949   0.093721  9.4424 < 2.2e-16 ***
#> UE60_1        -0.021774   0.034003 -0.6404  0.521983    
#> SOUTH_1        1.354664   0.244606  5.5382 3.314e-08 ***
#> rho_1          0.370632   0.030271 12.2436 < 2.2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> R-squared: 0.3409 
#>   
...
#> model 2: slm -9098.5  9 18215 18197 155.71 9.805e-36
```
...
#> Equation  1 
#>                  Estimate  Std. Error t value  Pr(>|t|)    
#> (Intercept)_1  3.99354886  0.80980919  4.9315 8.594e-07 ***
#> RD60_1         1.11201434  0.14804917  7.5111 7.638e-14 ***
#> PS60_1         0.24285142  0.09010103  2.6953   0.00707 ** 
#> MA60_1        -0.12913458  0.02271825 -5.6842 1.437e-08 ***
#> DV60_1         0.73146230  0.10670843  6.8548 8.595e-12 ***
#> UE60_1         0.00064201  0.03483656  0.0184   0.98530    
#> SOUTH_1        0.63822931  0.34132155  1.8699   0.06160 .  
#> rho_1          0.57744206  0.07411084  7.7916 8.979e-15 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> R-squared: 0.3447 
#>   
...
#> Coefficients: 
#>                Estimate  Std. Error t value  Pr(>|t|)
#> Rho          0.57744206  0.07419509  7.7828 7.105e-15
#> (Intercept)  3.99354886  0.81072980  4.9259 8.399e-07
#> RD60         1.11201434  0.14821748  7.5026 6.262e-14
#> PS60         0.24285142  0.09020346  2.6923  0.007097
#> MA60        -0.12913458  0.02274408 -5.6777 1.365e-08
#> DV60         0.73146230  0.10682974  6.8470 7.542e-12
#> UE60         0.00064201  0.03487617  0.0184  0.985313
#> SOUTH        0.63822931  0.34170958  1.8678  0.061796
#> 
...
#> Time to fit the model:  1.91  seconds
#> Time to compute covariances:  67.81  seconds
```
...
#> Equation  1 
#>                Estimate Std. Error t value  Pr(>|t|)    
#> (Intercept)_1  7.527394   0.766797  9.8167 < 2.2e-16 ***
#> RD60_1         1.742351   0.148661 11.7203 < 2.2e-16 ***
#> PS60_1         0.346996   0.109246  3.1763  0.001507 ** 
#> MA60_1        -0.208241   0.023395 -8.9013 < 2.2e-16 ***
#> DV60_1         0.957295   0.108403  8.8309 < 2.2e-16 ***
#> UE60_1         0.018158   0.039940  0.4546  0.649409    
#> SOUTH_1        2.494771   0.316304  7.8873 4.255e-15 ***
#> lambda_1       0.382536   0.032105 11.9151 < 2.2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> R-squared: 0.3388 
#>   
...
#>               logLik df   AIC   BIC LRtest      p.val
#> model 1: sim -9176.3  8 18369 18353                  
#> model 2: sem -9106.0  9 18230 18212 140.59 1.9786e-32
```
...
#> Time to fit the model:  44.37  seconds
#> Time to compute covariances:  9.89  seconds
```
...
#> Equation  1 
#>                Estimate Std. Error  t value  Pr(>|t|)    
#> (Intercept)_1  2.421946   0.391455   6.1870 6.942e-10 ***
#> RD60_1         0.657214   0.079674   8.2488 2.344e-16 ***
#> PS60_1         0.149669   0.054110   2.7660  0.005708 ** 
#> MA60_1        -0.079578   0.011837  -6.7230 2.114e-11 ***
#> DV60_1         0.500917   0.063113   7.9369 2.880e-15 ***
#> UE60_1        -0.031826   0.021372  -1.4892  0.136550    
#> SOUTH_1        0.260660   0.127846   2.0389  0.041550 *  
#> rho_1          0.777937   0.018114  42.9474 < 2.2e-16 ***
#> lambda_1      -0.933030   0.083248 -11.2078 < 2.2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> R-squared: 0.4441 
#>   
...
#> model 2: sarar -9060.1 10 18140 18120 76.751 1.9393e-18
```
...
#> model 2: sarar -9060.1 10 18140 18120  91.87 9.2565e-22
```
