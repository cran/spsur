...
```
<div class="figure" style="text-align: center"><span id="fig:quantilemap"></span>
![](fig22_qmap_usa.png)
<p class="caption">
Figure 2.2: Quantile Map; Variable HR60
</p>
</div>
...
Figure <a href="#fig:quantilemap">2.2</a> points to the existence of cross-sectional dependence in the spatial distribution of HR60 but the model in \@ref(eq:ols) does not contain elements of spatial interaction. The consequence is a scattermap of the LS residuals, <a href="#fig:quantilemap">2.2</a>, with a strong structure of clusters, similar to that of HR60 in Figure <a href="#fig:residualquantilemap">2.3</a>.
...
```
<div class="figure" style="text-align: center"><span id="fig:residualquantilemap"></span>
![](fig23_qreslm_usa.png)
<p class="caption">
Figure 2.3: Quantile Map of LS residuals
</p>
</div>
...
#&gt; Time to compute covariances:  0.06  seconds
#&gt; Call:
...
Figure <a href="#fig:residualsurquantilemap">3.1</a> shows the quantile maps of the SUR residuals corresponding to the years 1960 and 1970. The maps reveal that time dependence was only part of the problem. Indeed, there remain a strong spatial structure in the SUR residuals which is apparently stable across time.
...
<div class="figure" style="text-align: center"><span id="fig:residualsurquantilemap"></span>
![](fig31_qressim_usa.png)
<p class="caption">
Figure 3.1: Quantile Map of LS residuals for SUR-SIM model
</p>
</div>
...
#&gt; Time to fit the model:  9.89  seconds
#&gt; Computing numerical covariances... 
#&gt; Time to compute covariances:  2.24  seconds
#&gt; Call:
#&gt; spsurml(formula = formula_sur, data = NCOVR.sf, listw = lwncovr, 
...
#&gt; Time to fit the model:  12.53  seconds
#&gt; Computing numerical covariances... 
#&gt; Time to compute covariances:  3.22  seconds
#&gt; Call:
#&gt; spsurml(formula = formula_sur, data = NCOVR.sf, listw = lwncovr, 
...
#&gt; 
#&gt;  R-sq. pooled:   0.4 
#&gt;  Breusch-Pagan: 134.5  p-value: (4.33e-31)</code></pre>
...
#&gt; Time to fit the model:  12.7  seconds
#&gt; Computing numerical covariances... 
#&gt; Time to compute covariances:  3.09  seconds
#&gt; Call:
#&gt; spsurml(formula = formula_sur, data = NCOVR.sf, listw = lwncovr, 
...
#&gt; 
#&gt;  R-sq. pooled: 0.4018 
#&gt;  Breusch-Pagan: 134.4  p-value: (4.4e-31)</code></pre>
...
#&gt; Time to fit the model:  9.47  seconds
#&gt; Time to compute covariances:  19.46  seconds
#&gt; Call:
#&gt; spsurml(formula = formula_sur, data = NCOVR.sf, listw = lwncovr, 
...
#&gt; Time to fit the model:  267.21  seconds
#&gt; Computing numerical covariances... 
#&gt; Time to compute covariances:  19.54  seconds
#&gt; Call:
#&gt; spsurml(formula = formula_sur, data = NCOVR.sf, listw = lwncovr, 
...
#&gt; 
#&gt;  R-sq. pooled: 0.4395 
#&gt;  Breusch-Pagan: 134.3  p-value: (4.63e-31)</code></pre>
...
<pre><code>
#&gt; Time to fit the model:  0.33  seconds
#&gt; Call:
#&gt; spsur3sls(formula = formula_sur, data = NCOVR.sf, listw = lwncovr, 
...
<pre class="r"><code>print(sur.sim$BP)</code></pre>
<pre><code>#&gt; [1] 211.1929</code></pre>
<pre class="r"><code>print(sur.slm$BP)</code></pre>
<pre><code>#&gt; [1] 132.8747</code></pre>
<pre class="r"><code>print(sur.slm.3sls$BP)</code></pre>
<pre><code>#&gt; [1] 195.0408</code></pre>
...
#&gt; Iteration:  2   log_lik:  -18761.48  rhos:  0.347 0.393 
#&gt; Iteration:  3   log_lik:  -18761.48  rhos:  0.347 0.393 
#&gt; Time to fit the model:  9.7  seconds
#&gt; Time to compute covariances:  17.2  seconds
#&gt; Call:
#&gt; spsurml(formula = formula_sur, data = NCOVR.sf, listw = lwncovr, 
#&gt;     type = &quot;slm&quot;, method = &quot;LU&quot;)
#&gt; 
...
#&gt; Time to fit the model:  3.39  seconds
#&gt; Time to compute covariances:  17.28  seconds
#&gt; Call:
#&gt; spsurml(formula = formula_sur, data = NCOVR.sf, listw = lwncovr, 
...
#&gt; Time to fit the model:  3.57  seconds
#&gt; Time to compute covariances:  15.32  seconds
#&gt; Call:
#&gt; spsurml(formula = formula_sur, data = NCOVR.sf, listw = lwncovr, 
...
```{r SUR-SLM-R-3SLS, eval=FALSE, include=FALSE}
...
<pre class="r"><code>logLik(sur.sim)</code></pre>
<pre><code>#&gt; &#39;log Lik.&#39; -18908.64 (df=17)</code></pre>
<pre class="r"><code>logLik(sur.slx)</code></pre>
<pre><code>#&gt; &#39;log Lik.&#39; -18855.21 (df=29)</code></pre>
<pre class="r"><code>logLik(sur.sarar)</code></pre>
<pre><code>#&gt; &#39;log Lik.&#39; -18722.42 (df=21)</code></pre>
...
```
<pre class="r"><code>summary(sur.sdm.impacts[[1]], zstats = TRUE, short = TRUE)</code></pre>
<pre><code>
#&gt; Impact measures (lag, trace):
#&gt;              Direct    Indirect       Total
#&gt; RD60_1   1.35219737  0.69037008  2.04256745
#&gt; PS60_1   0.27818832  0.14203022  0.42021855
#&gt; MA60_1  -0.16906166 -0.08631515 -0.25537681
#&gt; DV60_1   0.89111929  0.45496472  1.34608401
#&gt; UE60_1  -0.03085081 -0.01575101 -0.04660181
#&gt; SOUTH_1  1.52612098  0.77916752  2.30528850
#&gt; ========================================================
#&gt; Simulation results ( variance matrix):
#&gt; ========================================================
#&gt; Simulated standard errors
#&gt;             Direct   Indirect      Total
#&gt; RD60_1  0.12035328 0.10732963 0.20366999
#&gt; PS60_1  0.08914544 0.04896733 0.13555536
#&gt; MA60_1  0.01828030 0.01440198 0.02984564
#&gt; DV60_1  0.08918449 0.07282291 0.14630863
#&gt; UE60_1  0.03284175 0.01705939 0.04975678
#&gt; SOUTH_1 0.22624410 0.14688836 0.35071267
#&gt; 
#&gt; Simulated z-values:
#&gt;             Direct  Indirect      Total
#&gt; RD60_1  11.2575347  6.477509 10.0658415
#&gt; PS60_1   3.1682805  2.956504  3.1515529
#&gt; MA60_1  -9.2527968 -6.025332 -8.5748080
#&gt; DV60_1  10.0082398  6.286542  9.2296953
#&gt; UE60_1  -0.8525197 -0.842567 -0.8515808
#&gt; SOUTH_1  6.7290893  5.312141  6.5657978
#&gt; 
#&gt; Simulated p-values:
#&gt;         Direct     Indirect   Total     
#&gt; RD60_1  &lt; 2.22e-16 9.3249e-11 &lt; 2.22e-16
#&gt; PS60_1  0.0015334  0.0031115  0.001624  
#&gt; MA60_1  &lt; 2.22e-16 1.6876e-09 &lt; 2.22e-16
#&gt; DV60_1  &lt; 2.22e-16 3.2462e-10 &lt; 2.22e-16
#&gt; UE60_1  0.3939257  0.3994707  0.394447  
#&gt; SOUTH_1 1.7073e-11 1.0834e-07 5.1755e-11
</code></pre>
<pre class="r"><code>summary(sur.sdm.impacts[[2]], zstats = TRUE, short = TRUE)
</code></pre>
<pre><code>#&gt; Impact measures (lag, trace):
#&gt;             Direct    Indirect      Total
#&gt; RD70_2   2.2406315  1.38760429  3.6282358
#&gt; PS70_2   0.6600999  0.40879434  1.0688942
#&gt; MA70_2  -0.1240251 -0.07680773 -0.2008329
#&gt; DV70_2   1.0050897  0.62244360  1.6275333
#&gt; UE70_2  -0.1719949 -0.10651503 -0.2785100
#&gt; SOUTH_2  1.6457998  1.01923001  2.6650298
#&gt; ========================================================
#&gt; Simulation results ( variance matrix):
#&gt; ========================================================
#&gt; Simulated standard errors
#&gt;             Direct   Indirect      Total
#&gt; RD70_2  0.14922739 0.17945981 0.28973991
#&gt; PS70_2  0.11527744 0.08479694 0.19237464
#&gt; MA70_2  0.02272903 0.01641728 0.03777971
#&gt; DV70_2  0.09831653 0.09178150 0.17421380
#&gt; UE70_2  0.04576079 0.03089841 0.07525541
#&gt; SOUTH_2 0.27978377 0.21018151 0.47143086
#&gt; 
#&gt; Simulated z-values:
#&gt;            Direct  Indirect     Total
#&gt; RD70_2  14.973677  7.765510 12.521850
#&gt; PS70_2   5.747577  4.872933  5.592087
#&gt; MA70_2  -5.461830 -4.713107 -5.334040
#&gt; DV70_2  10.211679  6.821450  9.356664
#&gt; UE70_2  -3.753999 -3.467750 -3.706497
#&gt; SOUTH_2  5.909475  4.907767  5.695209
#&gt; 
#&gt; Simulated p-values:
#&gt;         Direct     Indirect   Total     
#&gt; RD70_2  &lt; 2.22e-16 8.2157e-15 &lt; 2.22e-16
#&gt; PS70_2  9.0531e-09 1.0995e-06 2.2436e-08
#&gt; MA70_2  4.7125e-08 2.4397e-06 9.6051e-08
#&gt; DV70_2  &lt; 2.22e-16 9.0126e-12 &lt; 2.22e-16
#&gt; UE70_2  0.00017404 0.00052483 0.00021015
#&gt; SOUTH_2 3.4320e-09 9.2119e-07 1.2322e-08
</code></pre>
...
#&gt; Time to compute covariances:  14.64  seconds
#&gt; Call:
...
#&gt; Time to fit the model:  16.92  seconds
#&gt; Computing numerical covariances... 
#&gt; Time to compute covariances:  2.26  seconds
#&gt; Call:
...
#&gt; Iteration:  3   log_lik:  -23814.73  rhos:  0.543 0.894 
#&gt; Iteration:  4   log_lik:  -23814.73  rhos:  0.543 0.894 
#&gt; Time to fit the model:  16.7  seconds
#&gt; Computing numerical covariances... 
#&gt; Time to compute covariances:  2.41  seconds
#&gt; Call:
#&gt; spsurml(formula = formula.panel, data = NCOVR.df, listw = lwncovr, 
#&gt;     type = &quot;slm&quot;, method = &quot;LU&quot;, Tm = 2, control = list(fdHess = TRUE))
#&gt; 
...
#&gt; Equation  1 
#&gt;            Estimate Std. Error t value  Pr(&gt;|t|)    
#&gt; Intercep_1 1.020014   0.056756  17.972 &lt; 2.2e-16 ***
#&gt; X1_1       1.985442   0.042649  46.553 &lt; 2.2e-16 ***
#&gt; X1_2       3.025420   0.038997  77.581 &lt; 2.2e-16 ***
#&gt; rho_1      0.479492   0.017218  27.848 &lt; 2.2e-16 ***
#&gt; ---
#&gt; Signif. codes:  0 &#39;***&#39; 0.001 &#39;**&#39; 0.01 &#39;*&#39; 0.05 &#39;.&#39; 0.1 &#39; &#39; 1
#&gt; R-squared: 0.9363 
#&gt;   Equation  2 
#&gt;             Estimate Std. Error t value  Pr(&gt;|t|)    
#&gt; Intercep_2  0.924022   0.079874  11.569 &lt; 2.2e-16 ***
#&gt; X2_1       -0.951509   0.041033 -23.189 &lt; 2.2e-16 ***
#&gt; X2_2        0.494227   0.039422  12.537 &lt; 2.2e-16 ***
#&gt; rho_2       0.529666   0.034843  15.201 &lt; 2.2e-16 ***
#&gt; ---
#&gt; Signif. codes:  0 &#39;***&#39; 0.001 &#39;**&#39; 0.01 &#39;*&#39; 0.05 &#39;.&#39; 0.1 &#39; &#39; 1
#&gt; R-squared: 0.6355 
#&gt;   Equation  3 
#&gt;             Estimate Std. Error t value  Pr(&gt;|t|)    
#&gt; Intercep_3  1.009111   0.065093  15.503 &lt; 2.2e-16 ***
#&gt; X3_1       -0.550866   0.044171 -12.471 &lt; 2.2e-16 ***
#&gt; X3_2        2.010066   0.040896  49.151 &lt; 2.2e-16 ***
#&gt; rho_3       0.485751   0.024726  19.646 &lt; 2.2e-16 ***
#&gt; ---
#&gt; Signif. codes:  0 &#39;***&#39; 0.001 &#39;**&#39; 0.01 &#39;*&#39; 0.05 &#39;.&#39; 0.1 &#39; &#39; 1
#&gt; R-squared: 0.8467 
#&gt;   
#&gt; Variance-Covariance Matrix of inter-equation residuals:                              
#&gt;  0.9561968 0.3158594 0.3688782
#&gt;  0.3158594 0.9194943 0.2839303
#&gt;  0.3688782 0.2839303 0.9861331
#&gt; Correlation Matrix of inter-equation residuals:                              
#&gt;  1.0000000 0.3368570 0.3798758
#&gt;  0.3368570 1.0000000 0.2981738
#&gt;  0.3798758 0.2981738 1.0000000
#&gt; 
#&gt;  R-sq. pooled: 0.8807 
#&gt;  Breusch-Pagan: 173.3  p-value: (2.41e-37) 
#&gt;  LMM: 4.6851  p-value: (0.196)
</code></pre>
